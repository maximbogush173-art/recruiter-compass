...
const BLOCKS = [
  { name: "Подготовка вакансии", text: "бриф → проверяемые критерии" },
  { name: "Разбор и аутрич", text: "вердикты, вопросы, сообщения" },
  { name: "Сопровождение", text: "расшифровка, отзыв, соседняя роль" },
  { name: "Действия и отчёт", text: "подтверждение, запись, сводка" },
];
      ...
      <section className="hero" id="product">
        ...
        <div className="hero__content page-width">
          ...
          <p className="hero__lead">
            ...
            соседних ролей — агент делает черновую работу за рекрутера. По каждому кандидату остаётся
        ...
        <div className="demo-layout page-width">
          <aside className="product-info">
            ...
            <div className="product-info__note">
              ...
              <p>Всю черновую работу агент делает сам. Рекрутер принимает решение и подтверждает запись в Potok.</p>
            </div>
          </aside>
